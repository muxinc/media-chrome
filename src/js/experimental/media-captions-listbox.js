...
class MediaCaptionsListbox extends MediaChromeListbox {
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (
      ...
      console.warn(
        "Captions List doesn't currently support multiple selections. You can enable multiple items via the media.textTrack API."
      );
    }
  }
  ...
  #onChange() {
    ...
    if (preferredLanguage) {
      const mediaController = this.hasAttribute(
