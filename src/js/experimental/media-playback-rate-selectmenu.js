...
/**
 * @typedef {import('../media-playback-rate-button.js').MediaPlaybackRateButton} MediaPlaybackRateButton
 */
...
class MediaPlaybackRateSelectMenu extends MediaChromeSelectMenu {
  init() {
    const playbackRateButton = /** @type {MediaPlaybackRateButton} */ (
      /** @type {unknown} */ document.createElement(
