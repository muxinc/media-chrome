...
template.innerHTML = `
  <style>
    ...
    :host(:not([audio])) [part~=media-layer] {
      min-width: 100%;
      min-height: 100%;
      max-width: 100%;
      max-height: 100%;
...
class MediaContainerTest extends window.HTMLElement {
  constructor() {
    super();
...
defineCustomElement('media-container-test', MediaContainerTest);

export default MediaContainerTest;
