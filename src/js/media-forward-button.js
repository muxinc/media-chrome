...
class MediaForwardButton extends MediaChromeButton {
  constructor() {
    super();
...
if (!window.customElements.get('media-forward-button')) {
  window.customElements.define('media-forward-button', MediaForwardButton);
  window.MediaChrome = MediaForwardButton;
}

export default MediaForwardButton;
