...
*/
import MediaContainerTest from './media-container-test.js';
...
class MediaControllerTest extends MediaContainerTest {
  constructor() {
    super();
...
defineCustomElement('media-controller-test', MediaControllerTest);

export default MediaControllerTest;
