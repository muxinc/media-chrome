...
class MediaReplayButton extends MediaChromeButton {
  constructor() {
    super();
...
if (!window.customElements.get('media-replay-button')) {
  window.customElements.define('media-replay-button', MediaReplayButton);
  window.MediaChrome = MediaReplayButton;
}

export default MediaReplayButton;
