  ...
  return (
    ...
    >
      ...
      <MediaControlBar className={clsx('h-9 lg:h-11')}>
        <MediaPlayButton
          className={clsx('hidden', 'lg:block', 'p-1.5', 'lg:p-2.5', {
            'bg-primary-600': isSelectedInControlBar(
              MediaPlayButton,
              selectedItem
            ),
        ...
        ></MediaMuteButton>
        <MediaVolumeRange
          className={clsx('h-auto', 'p-1.5', 'lg:p-2.5', {
            'bg-primary-600': isSelectedInControlBar(
              MediaVolumeRange,
              selectedItem
            ),
        ...
        ></MediaVolumeRange>
        <div
          className={clsx('flex-grow', 'lg:hidden ', {
        ...
        ></div>
        <MediaTimeRange
          className={clsx('hidden', 'h-auto', 'lg:block', 'p-1.5', 'lg:p-2.5', {
            'bg-primary-600': isSelectedInControlBar(
              MediaTimeRange,
              selectedItem
            ),
        ...
        ></MediaTimeRange>
        <MediaTimeDisplay
          className={clsx('hidden', 'lg:flex', 'p-1.5', 'lg:p-2.5', {
            'bg-primary-600': isSelectedInControlBar(
              MediaTimeDisplay,
              selectedItem
            ),
        ...
        ></MediaCaptionsButton>
        <MediaPlaybackRateButton
          className={clsx('self-center', 'p-1.5', 'lg:p-2.5', {
            'bg-primary-600': isSelectedInControlBar(
              MediaPlaybackRateButton,
              selectedItem
            ),
