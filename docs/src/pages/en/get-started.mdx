...
When using a control outside of a `<media-controller>` wrapper element, the control needs to specify which media controller it should be associated with. To do this you can set the `media-controller` attribute.
