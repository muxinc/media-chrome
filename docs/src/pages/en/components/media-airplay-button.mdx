...
The `<media-airplay-button>` component is used to bring up the AirPlay menu and select AirPlay playback.

The behavior of the `<media-airplay-button>` will update automatically based on the availability of AirPlay support.

The button will display the contents of the `airplay` slot, if provided.
