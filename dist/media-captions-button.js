import E from"./media-chrome-button.js";import{defineCustomElement as f}from"./utils/defineCustomElement.js";import{Window as r,Document as m}from"./utils/server-safe-globals.js";import{MediaUIEvents as c,MediaUIAttributes as t}from"./constants.js";import{nouns as A}from"./labels/labels.js";import{splitTextTracksStr as h}from"./utils/captions.js";const v=`
<svg
   aria-hidden="true"
...
`;const S=e=>{e.setAttribute("aria-checked",p(e))},p=e=>{const s=!!e.getAttribute(t.MEDIA_CAPTIONS_SHOWING),a=!e.hasAttribute("no-subtitles-fallback")&&!!e.getAttribute(t.MEDIA_SUBTITLES_SHOWING);return s||a};class I extends E{static get observedAttributes(){return[...super.observedAttributes,"no-subtitles-fallback",t.MEDIA_CAPTIONS_LIST,t.MEDIA_CAPTIONS_SHOWING,t.MEDIA_SUBTITLES_LIST,t.MEDIA_SUBTITLES_SHOWING]}constructor(s={}){super({slotTemplate:b,...s})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","switch"),this.setAttribute("aria-label",A.CLOSED_CAPTIONS()),S(this)}attributeChangedCallback(s,a,l){[t.MEDIA_CAPTIONS_SHOWING,t.MEDIA_SUBTITLES_SHOWING].includes(s)&&S(this),super.attributeChangedCallback(s,a,l)}handleClick(s){var l,C,d,u;if(p(this)){const i=this.getAttribute(t.MEDIA_CAPTIONS_SHOWING);if(i){const n=new r.CustomEvent(c.MEDIA_DISABLE_CAPTIONS_REQUEST,{composed:!0,bubbles:!0,detail:i});this.dispatchEvent(n)}const o=this.getAttribute(t.MEDIA_SUBTITLES_SHOWING);if(o&&!this.hasAttribute("no-subtitles-fallback")){const n=new r.CustomEvent(c.MEDIA_DISABLE_SUBTITLES_REQUEST,{composed:!0,bubbles:!0,detail:o});this.dispatchEvent(n)}}else{const[i]=(C=h((l=this.getAttribute(t.MEDIA_CAPTIONS_LIST))!=null?l:""))!=null?C:[];if(i){const o=new r.CustomEvent(c.MEDIA_SHOW_CAPTIONS_REQUEST,{composed:!0,bubbles:!0,detail:i});this.dispatchEvent(o)}else if(this.hasAttribute("no-subtitles-fallback"))console.error("Attempting to enable closed captions but none are available! Please verify your media content if this is unexpected.");else{const[o]=(u=h((d=this.getAttribute(t.MEDIA_SUBTITLES_LIST))!=null?d:""))!=null?u:[];if(o){const n=new r.CustomEvent(c.MEDIA_SHOW_SUBTITLES_REQUEST,{composed:!0,bubbles:!0,detail:o});this.dispatchEvent(n)}}}}}f("media-captions-button",I);export default I;
